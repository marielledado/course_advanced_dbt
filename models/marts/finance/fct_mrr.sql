...
{% set import_dates = unit_testing_select_table(ref('dim_dates'), ref('unit_test_dim_dates')) %}
{% set import_subs = unit_testing_select_table(ref('dim_subscriptions'), ref('unit_test_dim_subscriptions')) %}
